...
export default function ProductDetail() {
  ...
  const { cart, setCart, getCart, handleClick, handleChange } = useCartItems();

  return (
    <>
      <Navbarr cart={cart} setCart={setCart} products={products} handleChange={handleChange} />
              ...
              <div className="row">
                ...
                <div className="col-12 col-lg-6 col-md-6 d-flex align-items-center p-3 mb-5">
                  <div className="product-info product-page">
                    <h4 className="product-title fw-bold mb-1">{product.title}</h4>
                    ...
                    <div className="product-price d-flex align-items-center gap-3">
                      <div className="h5 fw-bold">${product.price}</div>
                    ...
                    <div className="cart-buttons mt-3">
                      <div className="buttons d-flex flex-column flex-lg-row gap-3 mt-4">
                        <Button
                          ...
                          onClick={() => handleClick(product, getCart)}
                        >
                          Add to Cart
                        </Button>
